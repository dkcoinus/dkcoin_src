...
#define PACKAGE_BUGREPORT "https://github.com/dkcoin/dkcoin/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "dkcoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "dkcoin Core 0.11.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "dkcoin"
