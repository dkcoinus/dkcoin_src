...
public:
    ...
    void setupUi(QDialog *SendCoinsDialog)
    {
        ...
        labelCoinControlAmount->setText(QStringLiteral("0.00 DKC"));
        ...
        labelCoinControlFee->setText(QStringLiteral("0.00 DKC"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 DKC"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 DKC"));
        ...
        labelBalance->setText(QStringLiteral("123.456 DKC"));
