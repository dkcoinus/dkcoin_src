...
"hash)"),
QT_TRANSLATE_NOOP("bitcoin-core", ""
"Fees (in DKC/Kb) smaller than this are considered zero fee for relaying "
"(default: %s)"),
QT_TRANSLATE_NOOP("bitcoin-core", ""
...
QT_TRANSLATE_NOOP("bitcoin-core", "Fee (in DKC/kB) to add to transactions you send (default: %s)"),
